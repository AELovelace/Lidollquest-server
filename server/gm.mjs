...
export const gmZones=Object.freeze([
 ...
 {id:'dive-autumnal-plains',category:ZONE_CATEGORY.OVERWORLD,name:'Autumnal Plains',kind:'dive',warp:false},
 {id:'dive-farmstead',category:ZONE_CATEGORY.OVERWORLD,name:'Farmstead',kind:'dive',warp:false},
 {id:'dive-seafoam-coast',category:ZONE_CATEGORY.OVERWORLD,name:'Seafoam Coast',kind:'dive',warp:false},
 {id:'dive-emberfall-caldera',category:ZONE_CATEGORY.OVERWORLD,name:'Emberfall Caldera',kind:'dive',warp:false},
 {id:'dive-obsidian-spa',category:ZONE_CATEGORY.OVERWORLD,name:'Obsidian Spa',kind:'dive',warp:false},
