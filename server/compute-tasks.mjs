...
export const GENERATORS=Object.freeze({rooms:generateFloor,desert:generateDesert,forest:generateForest,mansion:generateMansion}); // Worker-safe generator names; dive.mjs sends the name, never a function.
