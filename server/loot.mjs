...
export const DEFAULT_TUNING=Object.freeze({
 ...
 exposed_wet_dignity:8,exposed_tum_dignity:14, // Autumnal Plains: Dignity lost per wetting/mess out in the open fields even with nobody on screen (client online_dignity_witnessed), before the Shame multiplier.
 exposed_witness_percent:150,cover_witness_percent:50,rain_dignity_percent:50, // Plains: witnessed loss x150% in the open, x50% in tall grass/shelter; any accident Dignity loss x50% while it rains.
 unnoticed_continence_below:30,unnoticed_chance_percent:50,unnoticed_turns_min:25,unnoticed_turns_max:50,unnoticed_wet_dignity:20,unnoticed_tum_dignity:32,unnoticed_per_turn_dignity:1, // Unnoticed accidents (client accident_unnoticed_roll): below this continence %, this % chance an accident goes unnoticed for min..max turns; discovering it costs these amounts per wetting/mess plus per turn spent unaware (Shame scales it).
 smell_dignity_per_mess:32,smell_dignity_max:128,
 arcadia_scrutiny_percent:150,arcadia_visible_padding_pts:20,arcadia_childish_shame_percent:150,arcadia_little_childish:5,arcadia_little_tax_percent:50,arcadia_toilet_price:5, // Arcadia's Big Rules (server arcadia-rules.mjs, client online_in_arcadia): accident Dignity x scrutiny %; Shame points for padding that shows; childish-outfit Shame x %; the average childishness (0-10) that marks you as a little; merchants' markup % for littles; LiDollCoins per pay toilet.
 utopia_pod_dignity:8,utopia_padding_shame_pts:15,utopia_adult_clothes_shame_pts:8,utopia_smell_percent:50, // Utopia's Padded Pride (client online_in_utopia): Dignity each Nap Pod rest turn returns; Shame points padding removes and each adult garment adds; % of the usual smell Dignity borrowed. Accidents there cost no Dignity at all. // Temporary Dignity borrowed per mess still worn, capped; returned on changing (client online_smell_dignity_sync). Not multiplied.
