...
const SCALAR_BOUNDS={
 ...
 defeat_dignity_loss:[0,1024],defeat_dignity_childish_extra:[0,1024],witnessed_wet_dignity:[0,1024],witnessed_tum_dignity:[0,1024],exposed_wet_dignity:[0,1024],exposed_tum_dignity:[0,1024],exposed_witness_percent:[0,1000],cover_witness_percent:[0,1000],rain_dignity_percent:[0,1000],unnoticed_continence_below:[0,100],unnoticed_chance_percent:[0,100],unnoticed_turns_min:[0,500],unnoticed_turns_max:[0,500],unnoticed_wet_dignity:[0,1024],unnoticed_tum_dignity:[0,1024],unnoticed_per_turn_dignity:[0,100],smell_dignity_per_mess:[0,1024],smell_dignity_max:[0,1024],arcadia_scrutiny_percent:[0,1000],arcadia_visible_padding_pts:[0,100],arcadia_childish_shame_percent:[0,1000],arcadia_little_childish:[0,10],arcadia_little_tax_percent:[0,1000],arcadia_toilet_price:[0,1000],utopia_pod_dignity:[0,1024],utopia_padding_shame_pts:[0,100],utopia_adult_clothes_shame_pts:[0,100],utopia_smell_percent:[0,1000], // Online Dignity amounts (dignity.mjs); 0 turns that source off.
 ...
 move_delay_ms:[50,2000],crawl_move_delay_ms:[50,4000],move_burst_steps:[1,12], // 1 = no queued walking (every step waits its full delay). // Online step cooldowns in milliseconds (crawl.mjs movementDelay). Below 50 ms clients would be refused on ordinary clock drift.
};
