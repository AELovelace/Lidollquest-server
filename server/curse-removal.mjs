...
import {slotsUsed} from './loadout.mjs'; // Slot cap ignores stacks.
...
export function removeCursedGear(loadout,slot,itemId,catalog,capacity){
 ...
 if(!dispose&&slotsUsed(next.inventory)>=capacity)fail('Inventory full. Make room before removing this item. No coins were charged.');
