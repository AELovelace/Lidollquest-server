...
import {desertData,tundraData,taigaData,highDesertData,hauntedWoodsData,spookyMansionData,autumnalPlainsData,farmsteadData,coastData,calderaData,spaData} from '../server/zones.mjs';
...
const definitions=[diveData,desertData,tundraData,taigaData,highDesertData,hauntedWoodsData,spookyMansionData,autumnalPlainsData,farmsteadData,coastData,calderaData,spaData,...campaignDives];
const generation=definitions.map(data=>({generator:data===spookyMansionData?'mansion':data===farmsteadData?'farmstead':data===spaData?'spa':data===hauntedWoodsData?'forest':[desertData,tundraData,taigaData,highDesertData,autumnalPlainsData,coastData,calderaData].includes(data)?'desert':'rooms',data,edition:'2026-09-14'}));
