...
import {desertData,tundraData,taigaData} from '../server/zones.mjs';
...
const definitions=[diveData,desertData,tundraData,taigaData,...campaignDives];
const generation=definitions.map(data=>({generator:[desertData,tundraData,taigaData].includes(data)?'desert':'rooms',data,edition:'2026-09-14'}));
