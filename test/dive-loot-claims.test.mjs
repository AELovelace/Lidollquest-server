...
test('successful claims alone use the floor allowance; full bags, duplicate commands and reconnects retain it',()=>{
 ...
 function enter(){act('enter',{zone:'honeydew-lantern',loadout:{player_info:{playerHealth:100,playerHealthMax:100},inventory:[]}});place({x:10,y:3});act('hub_visit',{zone:'honeydew-lantern-dives'});place({x:6,y:5});return act('dive_enter',{zone:'dive-quarters'});}
 try{
  ...
  act('dive_exit');place({x:10,y:9});act('hub_visit',{zone:'honeydew-lantern'});act('leave');
