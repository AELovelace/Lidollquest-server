...
test('district travel, monthly persistence, talks, shared chat and safe live rollover preserve character state',()=>{
 ...
 const act=(action,extra={})=>{now+=500;const value=api.act('',{action,controller:'browser',request_id:randomUUID(),character_id:c?.id,revision:c?.revision,...extra});c=value.character;return value;};
